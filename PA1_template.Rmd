...
<h3><a id="user-content-loading--preprocessing-data" class="anchor" href="#loading--preprocessing-data" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Loading &amp; Preprocessing Data</h3>
...
<h3><a id="user-content-histogram-mean--median" class="anchor" href="#histogram-mean--median" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Histogram, Mean &amp; Median</h3>
...
<p><strong>Make The Histogram, And Report on Mean and Median:</strong></p>
